...
try {
jQInf(jQInf('body').get(0)).find("img[src*='https://cdn.shopify.com/s/files/1/2665/0346/files/loader.gif?v=1643994666']").each(function() {
...
if(loaderMode == 1) {
jQInf(jQInf(paginateSelector).get(0)).after('<div style="width: 100%;" id="gscollectionbottom"><center><img style="margin-top: 10px;" src="https://cdn.shopify.com/s/files/1/2665/0346/files/Barline-Loading-Images-1.gif?v=1640892122"></center></div>');
}
else {
	jQInf(jQInf(paginateSelector).get(0)).after('<div style="width: 100%;" id="gscollectionbottom"><center> <button id="gsloadmore" style="max-width: 250px; border: 1px solid; border-radius: 5px; padding-left: 20px; padding-right: 20px; padding-bottom: 3px; padding-top: 3px; margin-top: 20px;" type="button">' + loadMoreBtnText + '</button> <img id="gsloaderimg" style="margin-top: 10px; display: none;" src="https://cdn.shopify.com/s/files/1/2665/0346/files/Barline-Loading-Images-1.gif?v=1640892122"> </center></div>');
}
}
else {
	if(loaderMode == 1) {
	jQInf(jQInf("#bc-sf-filter-products").get(0)).after('<div style="width: 100%;" id="gscollectionbottom"><center><img style="margin-top: 10px;" src="https://cdn.shopify.com/s/files/1/2665/0346/files/Barline-Loading-Images-1.gif?v=1640892122"></center></div>');
	}
	else {
...
jQInf(appendedSection).find("img[src*='https://cdn.shopify.com/s/files/1/2665/0346/files/loader.gif?v=1643994666']").each(function() {
		if(jQInf(this).hasClass("product_image--current")) {
        	jQInf(this).attr("src", jQInf(this).attr('data-src'));
		}
});
